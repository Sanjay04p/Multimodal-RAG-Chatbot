...
* **Fast Inference:** Powered by Llama 3.3 on Groq for near-instant text generation and response synthesis.
...
* **Orchestration & Generation:** `LangChain` manages conversation memory and retrieves the Top-K most relevant context chunks to ground the `Llama 3.3 70B` model, preventing hallucinations.
