...
* **Fast Inference:** Powered by Llama 3.1 on Groq for near-instant text generation and response synthesis.
...
* **Orchestration & Generation:** `LangChain` manages conversation memory and retrieves the Top-K most relevant context chunks to ground the `Llama 3.1 8B` model, preventing hallucinations.
