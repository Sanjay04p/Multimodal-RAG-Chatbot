...
* **Fast Inference:** Powered by openai/gpt-oss-20b on Groq for near-instant text generation and response synthesis.
...
* **Orchestration & Generation:** `LangChain` manages conversation memory and retrieves the Top-K most relevant context chunks to ground the `openai/gpt-oss-20b` model, preventing hallucinations.
